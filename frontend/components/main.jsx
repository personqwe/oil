 ...
 * @see https://v0.dev/t/iPlI04coZR6
 */
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          <Card>
            <CardHeader className="flex flex-row items-center justify-between pb-2 space-y-0">
              <CardTitle className="text-sm font-medium">National Average Fuel Prices</CardTitle>
              <FuelIcon className="w-4 h-4 text-gray-500 dark:text-gray-400" />
            </CardHeader>
            <CardContent>
              <div className="text-2xl font-bold">Gasoline: $2.89</div>
              <p className="text-xs text-gray-500 dark:text-gray-400">per gallon</p>
              <div className="text-2xl font-bold">Diesel: $2.99</div>
              <p className="text-xs text-gray-500 dark:text-gray-400">per gallon</p>
              <div className="text-2xl font-bold">Premium Gasoline: $3.09</div>
              <p className="text-xs text-gray-500 dark:text-gray-400">per gallon</p>
              <div className="text-2xl font-bold">Kerosene: $2.79</div>
              <p className="text-xs text-gray-500 dark:text-gray-400">per gallon</p>
            </CardContent>
          </Card>
          <Card>
